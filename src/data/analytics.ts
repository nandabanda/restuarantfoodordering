...
export const menuOpportunities = [
  ...
  { item: "Late Night Snacks", gap: "Energy drink attach opportunity", potential: "₹90L" },
  { item: "Breakfast Beverages", gap: "Fruit drink under-indexed", potential: "₹1.2Cr" },
];

export const productGaps = [
  { product: "Cola Zero", current: 28, target: 45, gap: 17 },
  { product: "Energy Drink", current: 34, target: 50, gap: 16 },
  { product: "Fruit Drink", current: 22, target: 35, gap: 13 },
  { product: "Orange Sparkle", current: 18, target: 30, gap: 12 },
  { product: "Premium Water", current: 31, target: 40, gap: 9 },
];
...
export const consumerBehavior = [
  ...
  { behavior: "Beverage Add-on", percentage: 64, trend: "+6%" },
...
export const restaurantSegmentation = [
  ...
  { segment: "New Onboarded", count: 387, attachRate: 35, color: "#7C3AED" },
];

export const beverageByCuisine = [
  { cuisine: "Biryani", colaClassic: 45, energyDrink: 12, fruitDrink: 8, other: 35 },
  { cuisine: "QSR", colaClassic: 62, energyDrink: 18, fruitDrink: 5, other: 15 },
  { cuisine: "Pizza", colaClassic: 28, energyDrink: 8, fruitDrink: 12, other: 52 },
  { cuisine: "South Indian", colaClassic: 22, energyDrink: 6, fruitDrink: 38, other: 34 },
  { cuisine: "Chinese", colaClassic: 35, energyDrink: 10, fruitDrink: 15, other: 40 },
  { cuisine: "Café", colaClassic: 18, energyDrink: 8, fruitDrink: 10, other: 64 },
];
...
export const aiOpportunities = [
  {
    ...
    description: "842 outlets with 71% attach — expand trade campaigns to 200 new biryani outlets.",
  ...
  },
  {
    ...
    description: "Cafés growing 22% YoY but only 48% attach. Launch premium cola pairing program.",
    revenue: "₹1.8Cr potential",
    priority: "High",
  },
  {
    id: "opp3",
    title: "Late Night Energy Activation",
    description: "Late night footfall up 15% — energy drink attach only 34%. Target QSR & casual dining.",
